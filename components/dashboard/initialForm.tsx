...
import { ArrowRight, Building2, ChevronLeft, Command, Globe, LinkIcon, Sparkle, Sparkles } from "lucide-react";
...
const InitialForm = () => {
  ...
  return (
    <div className="w-full max-w-xl mx-auto min-h-100 flex flex-col justify-center">
      ...
      {isSubmitting ? (
        <div className="flex flex-col justify-center items-center text-center animate-in fade-in duration-700">
          <div className="relative mb-8">
            ...
            <div className="relative w-16 h-16 bg-linear-to-tr from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center shadow-lg shadow-indigo-500/20">
              <Sparkle className="w-8 h-8 text-white animate-bounce" />
            </div>
          </div>
            ...
            <div className="flex items-center gap-2">
              {currentStep > 0 && (
                <Button
                  ...
                  size="icon"
                  onClick={handleBack}
                  className="text-zinc-600 hover:text-zinc-300 hover:bg-white/5 rounded-full -ml-2 w-8 h-8 "
                >
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              {stepData.type === "textarea" ? (
                <Textarea
                  ...
                  className="w-full bg-transparent border-0 border-b border-zinc-600"
                  autoFocus
                />
              ) : (
                <Input
                  ...
                  onKeyDown={handleKeyDown}
                  placeholder={stepData.placeholder}
                  className="w-full bg-transparent border-0 border-b border-zinc-600 text-xl md:text-2xl py-4 pr-12 text-white placeholder:text-zinc-700 focus-visible:ring-0 focus-visible:border-indigo-600 rounded-none h-auto shadow-none transition-colors"
                  autoFocus
                />
              )}
            ...
            <div className="flex items-center justify-between pt-8">
              ...
              className={cn(
                ...
                !isStepValid ? "bg-zinc-800 text-zinc-500 hover:bg-zinc-800 cursor-not-allowed ":"bg-white text-black hover:bg-zinc-200 hover:shadow-lg hover:shadow-white/10"
              )}
              >
