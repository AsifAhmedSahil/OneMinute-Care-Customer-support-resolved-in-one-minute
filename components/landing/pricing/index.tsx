    ...
    <section id="pricing" className="py-32 px-6 max-w-6xl mx-auto text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        <div className="p-8 rounded-3xl border border-white/5 bg-zinc-900/20 flex flex-col items-start text-left hover:bg-zinc-900/40 transition-colors ">
          ...
          <ul className="space-y-3 mb-8 text-sm text-zinc-300 font-light w-full">
            <li className="flex items-center gap-3">
              <Check className="w-4 h-4 text-zinc-600" /> 100 conversation/mo
            </li>
            <li className="flex items-center gap-3">
        ...
        <div className="p-8 rounded-3xl relative overflow-hidden border border-white/10 bg-white/5 flex flex-col items-start text-left hover:bg-zinc-900/40 transition-colors ">
          ...
          <ul className="space-y-3 mb-8 text-sm text-zinc-300 font-light w-full">
            <li className="flex items-center gap-3">
              <Check className="w-4 h-4 text-indigo-600" /> unlimited conversation
            </li>
            <li className="flex items-center gap-3">
              <Check className="w-4 h-4 text-indigo-600" /> unlimited knowledge Source
            </li>
            <li className="flex items-center gap-3">
              <Check className="w-4 h-4 text-indigo-600" /> Community Support
            </li>
            <li className="flex items-center gap-3">
              <Check className="w-4 h-4 text-indigo-600" /> Custom Branding
            </li>
          </ul>
